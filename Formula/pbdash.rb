class Pbdash < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/jiseop121/pbdash/releases/download/v1.0.0/pbdash-v1.0.0-darwin-arm64.tar.gz"
      sha256 "REPLACE_ME_WITH_RELEASE_SHA_ARM64"
    else
      url "https://github.com/jiseop121/pbdash/releases/download/v1.0.0/pbdash-v1.0.0-darwin-amd64.tar.gz"
